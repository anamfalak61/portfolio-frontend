...
const API_URL = "https://portfolio-backend-black-rho.vercel.app";
    ...
    <div className="bg-[#0a0a0f] text-white">
      ...
      <section className="min-h-[85vh] flex items-center justify-center text-center relative px-6 pt-10 pb-10">
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-cyan-400 mb-3">
            Anam Falak
          </h1>
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <a
              href="#contact"
              className="px-7 py-3 bg-cyan-400 text-[#0a0a0f] font-semibold rounded-lg hover:-translate-y-1 transition-all"
            >
              Hire Me
            </a>
            ...
            <a
              href="#projects"
              className="px-7 py-3 border-2 border-cyan-400 text-cyan-400 font-semibold rounded-lg hover:bg-cyan-400/10 transition-all"
            >
              View Work
            </a>
          </div>
        ...
        <div className={containerClass}>
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            {skills.map((skill, i) => (
              <span
                key={i}
                className="px-5 py-2 bg-[#12121a] border border-gray-800 rounded-lg text-gray-300 hover:border-cyan-400/50 hover:text-cyan-400 transition-all"
              >
                {skill}
              </span>
            ))}
      ...
      <section
        id="projects"
        className={`${sectionClass} bg-[#0c0c12]`}
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-10">
            {projects.map((p, i) => (
              ...
              >
                <p className={`${p.typeColor} text-sm font-medium mb-2`}>
                  {p.type}
                </p>
                ...
                <div className="flex flex-wrap gap-2">
                  {p.tech.map((t) => (
                    <span
                      key={t}
                      className="px-3 py-1 bg-[#1e1e2a] text-gray-300 text-xs rounded-lg"
                    >
                      {t}
                    </span>
                  ))}
